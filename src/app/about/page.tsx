...
export default function AboutPage() {
  return (
    <main style={{ position: "relative" }}>
      ...
      {/* Locked screen background matching Raft layout */}
        ...
        <div style={{ width: "92%", margin: "0 auto", padding: "0 clamp(21px, 3.91vw, 49px)", maxWidth: "1200px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "clamp(57px, 6.256vw, 76px)", maxWidth: "800px", margin: "0 auto" }}>
            ...
            <section>
              ...
              {/* Divider */}
              <div style={{ height: "1px", background: "rgba(0,0,0,0.08)", marginBottom: "48px" }} />
            ...
            <section style={{ borderTop: "1px solid rgba(0,0,0,0.08)", paddingTop: "clamp(43px, 4.692vw, 56px)" }}>
              ...
              <h4 style={{ fontSize: "1rem", color: "#0F172A", marginBottom: "12px", fontWeight: 700 }}>From Manual Input to Strategic Audit</h4>
              <p style={{ color: "#475569", lineHeight: 1.8, fontSize: "1.05rem", marginBottom: "40px" }}>
              ...
              <p style={{ color: "#475569", lineHeight: 1.8, fontSize: "1.05rem", fontStyle: "italic" }}>
