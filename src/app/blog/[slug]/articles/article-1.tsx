...
const H2 = ({ children }: { children: React.ReactNode }) => (
  <h2 style={{ fontSize: "clamp(1.339rem, 1.96vw, 1.564rem)", color: "#F1F5F9", letterSpacing: "-0.02em", marginTop: "48px", marginBottom: "16px", lineHeight: 1.2 }}>
    {children}
  </h2>
);
const H3 = ({ children }: { children: React.ReactNode }) => (
  <h3 style={{ fontSize: "clamp(1.026rem, 1.168vw, 1.124rem)", color: "#CBD5E1", marginTop: "36px", marginBottom: "12px", lineHeight: 1.3 }}>
    {children}
  </h3>
);
const P = ({ children }: { children: React.ReactNode }) => (
  <p style={{ fontSize: "clamp(14px, 0.938vw, 15px)", color: "#94A3B8", lineHeight: 1.8, marginBottom: "20px" }}>
    {children}
  </p>
);
    ...
    <div>
      ...
      <ol style={{ listStyle: "none", padding: 0, margin: "0 0 24px 0", counterReset: "step" }}>
        {[
          ...
          <li key={i} style={{ display: "flex", gap: "16px", alignItems: "flex-start", fontSize: "clamp(14px, 0.938vw, 15px)", color: "#94A3B8", lineHeight: 1.7, marginBottom: "16px" }}>
