        ...
        {[
          ...
          <li key={i} style={{ marginBottom: "24px" }}>
            <div style={{ display: "flex", gap: "16px", alignItems: "flex-start" }}>
              <span style={{ color: "#6B8FA8", flexShrink: 0, fontWeight: 600, fontSize: "clamp(14px, 0.938vw, 15px)", minWidth: "32px" }}>{String(i + 1).padStart(2, "0")}.</span>
              <div>
                <strong style={{ color: "#F1F5F9", display: "block", marginBottom: "6px", fontSize: "clamp(14px, 0.938vw, 15px)" }}>{step.title}</strong>
                <span style={{ color: "#94A3B8", lineHeight: 1.7, fontSize: "clamp(14px, 0.938vw, 15px)" }}>{step.desc}</span>
              </div>
            </div>
          </li>
        ))}
