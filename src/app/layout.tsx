...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${workSans.variable} ${libreBaskerville.variable} antialiased dark`} style={{ fontFamily: "var(--font-worksans)" }}>
      <head>
        {/* SVG favicon — primary, always preferred by modern browsers */}
        <link rel="icon" href="/icon.svg" type="image/svg+xml" media="(prefers-color-scheme: dark)" />
        <link rel="icon" href="/icon-light.svg" type="image/svg+xml" media="(prefers-color-scheme: light)" />
        <link rel="icon" href="/icon.svg" type="image/svg+xml" />
        {/* ICO fallback — only used by browsers that don't support SVG favicons */}
