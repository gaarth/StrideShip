    ...
    <>
      ...
      <header
        ...
        style={{
          ...
          pointerEvents: "none",
          padding: isPillMode
            ? "clamp(12px, 1.8vw, 18px) clamp(24px, 4vw, 48px)"
            : "clamp(20px, 2.5vw, 32px) clamp(32px, 5vw, 64px)",
          display: "flex",
        ...
        <motion.nav
          ...
          style={{
            ...
            background: isPillMode
              ? "linear-gradient(135deg, rgba(76, 92, 116, 0.82) 0%, rgba(56, 70, 90, 0.72) 100%)"
              : "transparent",
        ...
        >
            ...
            {links.map((l) => (
              <button
                ...
                style={{
                  ...
                  border: "none",
                  color: "#FFFFFF",
                  fontSize: "clamp(0.85rem, 1.35vw, 0.92rem)",
                  fontWeight: 600,
                  padding: "8px 16px",
                  borderRadius: "9999px",
                  cursor: "pointer",
          ...
          <motion.div layout className="hidden md:block">
            <StarButton
              ...
              height={isPillMode ? 42 : 48}
              paddingX={isPillMode ? 22 : 28}
              fontSize={isPillMode ? "0.85rem" : "0.9rem"}
            >
              Book a Call
            </StarButton>
          </motion.div>
      ...
      <div className="navbar-mobile" style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 50, pointerEvents: "none" }}>
        ...
        <motion.button
          ...
          style={{
            ...
            cursor: "pointer",
            background: "linear-gradient(135deg, rgba(76, 92, 116, 0.85) 0%, rgba(56, 70, 90, 0.75) 100%)",
          ...
          {mobileOpen && (
            <motion.div
              ...
              style={{
                ...
                borderRadius: "20px",
                padding: "12px",
                background: "linear-gradient(135deg, rgba(76, 92, 116, 0.92) 0%, rgba(56, 70, 90, 0.88) 100%)",
                backdropFilter: "blur(20px) saturate(1.6)",
                WebkitBackdropFilter: "blur(20px) saturate(1.6)",
                border: "1px solid rgba(255, 255, 255, 0.28)",
            ...
            >
              ...
              >
                <BrandIcon size={18} />
                <span style={{ color: "#FFFFFF", fontSize: "1.1rem", fontWeight: 700, letterSpacing: "-0.02em" }}>
                  StrideShip
                </span>
              </div>
              ...
              <div style={{ padding: "12px 4px 4px" }}>
                <StarButton href="https://cal.com/gaarth-godbole/audit-call" height={44} paddingX={24} fontSize="0.9rem">
                  Book a Call
                </StarButton>
              </div>
            </motion.div>
