...
export function StarButton({
  ...
  const outerStyle: CSSProperties = {
    ...
    whiteSpace: "nowrap",
    isolation: "isolate",
    // CSS custom properties for the sweep animation
    "--duration": duration,
    ...
    <>
      ...
      <div
        style={{
          ...
          animation: `star-btn-sweep calc(var(--duration) * 1s) linear infinite`,
        } as CSSProperties}
      />
      {/* Star background fill */}
      <div
        style={{
          position: "absolute",
          inset: 0,
      ...
      {/* Text — guaranteed centered via parent flexbox */}
      <span
        style={{
          position: "relative",
          zIndex: 10,
